 ...
 */
class User extends \YAFF\Database\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'YAFF\\Database\\Entity\\User' . "\0" . 'id', '' . "\0" . 'YAFF\\Database\\Entity\\User' . "\0" . 'username', '' . "\0" . 'YAFF\\Database\\Entity\\User' . "\0" . 'password', '' . "\0" . 'YAFF\\Database\\Entity\\User' . "\0" . 'role', '' . "\0" . 'YAFF\\Database\\Entity\\User' . "\0" . 'salt');
        }
