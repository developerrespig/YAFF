 ...
 */
class Role extends \YAFF\Database\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'YAFF\\Database\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'YAFF\\Database\\Entity\\Role' . "\0" . 'name', '' . "\0" . 'YAFF\\Database\\Entity\\Role' . "\0" . 'role', '' . "\0" . 'YAFF\\Database\\Entity\\Role' . "\0" . 'users');
        }
